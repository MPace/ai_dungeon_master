...
@celery.task(bind=True, name='tasks.find_similar_memories')
...
@celery.task(bind=True, name='tasks.generate_embedding')
...
@celery.task(bind=True, name='tasks.store_memory_with_embedding')
...
@celery.task(bind=True, name='tasks.retrieve_memories')
